...
namespace Spotzer.Tests
{
    ...
    public class Hooks
    {
        ...
        public static void InitializeReport()
        {
            ...
            var htmlReporter = new ExtentHtmlReporter(@"E:\Projects\Spotzer\Spotzer\ExtentReport.html");
            ...
            //klov.ReportName = "Mahesh N" + DateTime.Now.ToString();
        ...
        public void InsertReportingSteps()
        {
            ...
            //PropertyInfo pInfo = typeof(ScenarioContext).GetProperty("PlaceOrder", BindingFlags.Instance | BindingFlags.NonPublic);
